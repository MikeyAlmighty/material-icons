...
const XboxControllerBatteryAlertIcon = ({
  size,
  ...props
}) => (
  <Svg
...
XboxControllerBatteryAlertIcon.displayName = 'XboxControllerBatteryAlertIcon'

XboxControllerBatteryAlertIcon.defaultProps = {
  size: 24
}

export default XboxControllerBatteryAlertIcon