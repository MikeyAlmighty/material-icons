...
const FileDocumentBoxRemoveIcon = ({
  size,
  ...props
}) => (
  <Svg
...
FileDocumentBoxRemoveIcon.displayName = 'FileDocumentBoxRemoveIcon'

FileDocumentBoxRemoveIcon.defaultProps = {
  size: 24
}

export default FileDocumentBoxRemoveIcon