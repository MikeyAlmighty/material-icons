...
const FileDocumentBoxPlusOutlineIcon = ({
  size,
  ...props
}) => (
  <Svg
...
FileDocumentBoxPlusOutlineIcon.displayName = 'FileDocumentBoxPlusOutlineIcon'

FileDocumentBoxPlusOutlineIcon.defaultProps = {
  size: 24
}

export default FileDocumentBoxPlusOutlineIcon