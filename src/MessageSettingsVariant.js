...
const MessageSettingsVariantIcon = ({
  size,
  ...props
}) => (
  <Svg
...
MessageSettingsVariantIcon.displayName = 'MessageSettingsVariantIcon'

MessageSettingsVariantIcon.defaultProps = {
  size: 24
}

export default MessageSettingsVariantIcon